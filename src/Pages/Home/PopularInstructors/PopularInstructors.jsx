    ...
    return (
        <section className="py-8 my-20 mb-40">
            <div className='container mx-auto px-4'>
                <h2 className="text-5xl text-center font-bold mb-16">Popular Instructors</h2>
                    ...
                    {instructors?.map((instructor, i) => (
                        <div key={i} className="card-body border rounded-xl">
                            ...
                            <div className=" bg-white dark:bg-transparent p-4">
                                <h3 className="text-3xl font-semibold mb-2">{instructor.name}</h3>
                                <p className="text-gray-500 font-semibold">Teaching: {instructor.className}</p>
                                <p className="text-gray-500 font-semibold mt-2">Students: {instructor.students}</p>
                            </div>
                        </div>
                    ))}
                </div>
